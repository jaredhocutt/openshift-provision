...
| `openshift_version`              | :heavy_check_mark: |                                      | The OpenShift version to install. This tool currently supports 3.9 and 3.10.<br><br>**IMPORTANT:** Make sure this value is quoted, otherwise 3.10 gets read as 3.1 instead of 3.10.             |
